...
#train
quantity_img=480
train_all=np.zeros((quantity_img*(len(lables)),1764),dtype=int)
data=np.zeros((quantity_img,1764),dtype=int)
for a in range(0,5):
...
#test
quantity_img=120
test_all=np.zeros((quantity_img*(len(lables)),1764),dtype=int)
data=np.zeros((quantity_img,1764),dtype=int)
for a in range(0,5):
    for i in range(0,quantity_img):
